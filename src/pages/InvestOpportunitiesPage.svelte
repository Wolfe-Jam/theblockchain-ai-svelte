<!-- Investment Opportunities - Exact Original Design -->
<script>
...
<style lang="postcss">
  ...
  .highlight-icon.sun-bg {
    background: linear-gradient(135deg, var(--brand-sun), #fbbf24);
  }
  ...
  .highlight-icon.ocean-bg {
    background: linear-gradient(135deg, var(--brand-ocean), var(--brand-sky));
  }
  ...
  .trust-bg .trust-logo {
    ...
    /* Removed filter to show original Zero Fraud Icon design */
  }
