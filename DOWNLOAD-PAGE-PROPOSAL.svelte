...
<svelte:head>
  ...
  <meta property="og:image" content="/convergent-economy-preview.jpg" />
</svelte:head>
        ...
        <div class="pdf-preview-card bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 mb-12">
          <div class="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div class="pdf-visual flex-shrink-0">
              <div class="relative">
                <img 
                  src="/convergent-economy-preview.jpg" 
                  alt="Report Preview" 
      ...
      <div class="container mx-auto px-4 text-center max-w-2xl">
        ...
        <div class="next-steps bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div class="step">
              <div class="text-cyan-400 font-bold mb-1">2. Explore Components</div>
              <div class="text-slate-300">Check out our marketplace for AI/blockchain tools</div>
            </div>
            <div class="step">
